...
public class Olympic {
	 ...
	 public static void createUser(){     //////OK
		 ...
		 try {
			 ...
			 System.out.println("input user_name £º");
			 String user_name=j.nextLine();
			 System.out.println("input role_id£º");
			 int role_id=j.nextInt();
			 System.out.println("input passkey£º");
	 ...
	 public static void createEvent(){   ///////////OK
		 ...
		 try {
			 ...
			 System.out.println("input datetime(yyyy-MM-dd) £º");
			 String datetime1=j.next();
			 System.out.println("input datetime(hh:mm:ss) £º");
	 ...
	 public static void addParticipant(){    ///////OK
		 ...
		 try {
			 ...
			 System.out.println("input birthdate(yyyy-MM-dd) £º");
			 String dob=j.next();
